...
if($_GET['islem']=="sil")
{
	...
	$resim_bul=mysql_fetch_array(mysql_query("select * from fotograf_galeri where id='$id'"));
	$resim_sil=unlink("../lib/images/fotograf_galeri/".$resim_bul['resim']);
	
	$fotograf_sil_sorgu = mysql_query("delete from fotograf_galeri where id='$id'");
               ...
               <div class="span12">
                  ...
                  <div class="widget box light-grey">
                     <div class="widget-title">
                        <h4><i class="icon-camera"></i> Fotoğraf Listesi</h4>
                     ...
                     <div class="widget-body">
                        <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              ...
                              <a href="foto_kategori_ekle.php" style="color:#FFF;">Fotoğraf Ekle</a> <i class="icon-plus"></i>
                              </div>
                           </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           <thead>
                              <tr>
                                 ...
                                 <th style="width:8px;">Kategorisi</th>
                                 <th> Fotoğraf Adı <i class="icon-angle-down" style="float:right;"></th>
                                 <th class="hidden-480">Fotoğraf Resmi <i class="icon-angle-down" style="float:right;"></th>
                           ...
                           <?php
						    $kategori_cek=mysql_query("select * from fotograf_galeri order by sira asc");
						   ...
						   ?>
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td>
								 <?php 
								 $kategori_id = $kategori_dizi['kategori'];
								 $kategori_cekk=mysql_query("select * from fotograf_galeri_kategori where id='$kategori_id'");
									while($kategori_dizii=mysql_fetch_array($kategori_cekk))
									{
								   ?> 
                                   <?=$kategori_dizii['kategori_adi']?>
                                   <?php } ?>
                                 </td>
                                 <td><?=$kategori_dizi['adi']?></td>
                                 <td><?php
								 if($kategori_dizi['resim']=="no-image")
								 {
								 echo "Resim yok";
								 }
								 else
								 {
								 ?>
                                 <a href="../lib/images/fotograf_galeri/<?=$kategori_dizi['resim']?>" target="_blank">Resmi Gör</a>
                                 <?php
								 }
								 ?></td>
								 ...
								 {
								 ?>
                                 <img src="assets/img/aktif.png" title="Aktiftir"><span style="opacity:0;">Aktiftir</span>
                                 <?php
								 }
								 else
								 {
								 ?>
                                 <img src="assets/img/pasif.png" title="Pasiftir"><span style="opacity:0;">Pasiftir</span>
                                 <?php
								 }
								 ?>
                                 </td>
                                 ...
                                 <a href="foto_ekle.php?islem=duzenle&id=<?=$kategori_dizi['id']?>" title="Düzenle">
