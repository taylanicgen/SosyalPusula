...
if($_POST['fotograf_sira'] && $_GET['islem']=="")
{
	...
	$hedef  = "../lib/images/fotograf_galeri/".$yeni_isim;
	...
	$kategori_ekle_sorgu=mysql_query("insert into fotograf_galeri (sira, 
														   			adi, 
														   			resim,
																	kategori,
																	durum) 
...
if($_POST['fotograf_sira'] && $_GET['islem']=="duzenle")
{
	...
	if($dosya!="")
	{
		$resim_bul=mysql_fetch_array(mysql_query("select * from fotograf_galeri where id='$duzenlenecek_id'"));
		$resim_sil=unlink("../lib/images/fotograf_galeri/".$resim_bul['resim']);
	
		$fotograf_duzenle_sorgu=mysql_query("update fotograf_galeri set durum='$durum', sira='$fotograf_sira', adi='$fotograf_adi', resim='$yeni_isim', kategori='$kategori' where id='$duzenlenecek_id'");
		
		$gitti=move_uploaded_file($kaynak,$hedef);		
	}
	else
	{	
	$fotograf_duzenle_sorgu=mysql_query("update fotograf_galeri set durum='$durum', sira='$fotograf_sira', adi='$fotograf_adi', kategori='$kategori' where id='$duzenlenecek_id'");
	}
...
if($_GET['islem']=="duzenle")
{
	...
	$fotograf_dizi=mysql_fetch_array(mysql_query("select * from fotograf_galeri where id='$foto_id'"));
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-camera"></i> Fotoğraf Ekleme / Güncelleme</h4>
                    ...
                    <?=$bilgi?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="control-group">
                              <label class="control-label">Fotoğraf Sırası</label>
                              <div class="controls">
                           ...
                           <div class="control-group">
                              <label class="control-label">Fotoğraf Adı</label>
                              <div class="controls">
