    ...
    return {
        ...
        init: function () {
            ...
            $('#sample_1').dataTable({
                ...
                "oLanguage": {
                    "sLengthMenu": "_MENU_ kayit göster her sayfada",
                    "oPaginate": {
                        "sPrevious": "önceki",
                        "sNext": "sonraki"
                    }
            ...
            jQuery('#sample_2_wrapper .dataTables_length select').addClass("input-small"); // modify table per page dropdown
            ...
            jQuery('#sample_3_wrapper .dataTables_length select').addClass("input-small"); // modify table per page dropdown
        }
