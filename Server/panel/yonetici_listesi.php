...
{
	$yonetici_id = $_GET['id'];
	$yonetici_sil_sorgu = mysql_query("delete from yonetici where yonetici_id='$yonetici_id'");
                  ...
                  <div class="widget box light-grey">
                     ...
                     <div class="widget-body">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           ...
                           <?php
						    $yonetici_cek=mysql_query("select * from yonetici order by yonetici_id desc");
							$i= 0;
							while($yonetici_dizi=mysql_fetch_array($yonetici_cek))
							{
								$i=$i+1;
						   ?>
