...
if($_GET['islem']=="sil")
{
	...
	$resim_bul=mysql_fetch_array(mysql_query("select * from duyurular where id='$id'"));
	$resim_sil=unlink("../lib/images/duyurular/".$resim_bul['resim']);
	
	$duyuru_sil_sorgu = mysql_query("delete from duyurular where id='$id'");
               ...
               <div class="span12">
                  ...
                  <div class="widget box light-grey">
                     <div class="widget-title">
                        <h4><i class="icon-bullhorn"></i> Duyuru Listesi</h4>
                     ...
                     <div class="widget-body">
                        <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              ...
                              <a href="duyuru_ekle.php" style="color:#FFF;">Duyuru Ekle</a> <i class="icon-plus"></i>
                              </div>
                           </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           <thead>
                              <tr>
                                 ...
                                 <th> Duyuru Adı <i class="icon-angle-down" style="float:right;"></th>
                                 <th class="hidden-480">Duyuru Resmi <i class="icon-angle-down" style="float:right;"></th>
                           ...
                           <?php
						    $duyuru_cek=mysql_query("select * from duyurular order by sira asc");
							while($duyuru_dizi=mysql_fetch_array($duyuru_cek))
							{
						   ?>
                           
                              <tr class="odd gradeX">
                                 <td><?=$duyuru_dizi['sira']?></td>
                                 <td><?=$duyuru_dizi['adi']?></td>
                                 <td>
                                 <?php
								 if($duyuru_dizi['resim']=="no-image")
								 {
								 echo "Resim yok";
								 }
								 else
								 {
								 ?>
                                 <a href="../lib/images/duyurular/<?=$duyuru_dizi['resim']?>" target="_blank">Resmi Gör</a>
                                 <?php
								 }
								 ?>
                                 ...
                                 <td >
                                 <a href="?islem=sil&id=<?=$duyuru_dizi['id']?>" title="Sil" onclick="return confirm('Silmek istediğinize emin misiniz ?')">
                                 <i class="icon-remove sercan_sil_icon"></i>
                                 </a>
                                 
                                 <a href="duyuru_ekle.php?islem=duzenle&id=<?=$duyuru_dizi['id']?>" title="Düzenle">
