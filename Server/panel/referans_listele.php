...
if($_GET['islem']=="sil")
{
	...
	$resim_bul=mysql_fetch_array(mysql_query("select * from referanslar where id='$id'"));
	$resim_sil=unlink("../lib/images/referanslar/".$resim_bul['resim']);
	
	$referanslar_sil_sorgu = mysql_query("delete from referanslar where id='$id'");
               ...
               <div class="span12">
                  ...
                  <div class="widget box light-grey">
                     <div class="widget-title">
                        <h4><i class="icon-tags"></i> Referans Listesi</h4>
                     ...
                     <div class="widget-body">
                        <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              ...
                              <a href="referans_ekle.php" style="color:#FFF;">Referans Ekle</a> <i class="icon-plus"></i>
                              </div>
                           </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           <thead>
                              <tr>
                                 ...
                                 <th> Referans Adı <i class="icon-angle-down" style="float:right;"></th>
                                 <th class="hidden-480">Resmi <i class="icon-angle-down" style="float:right;"></th>
                           ...
                           <?php
						    $referans_cek=mysql_query("select * from referanslar order by sira asc");
						   ...
						   ?>
                              ...
                              <tr class="odd gradeX">
								 ...
								 {
								 ?>
                                 <a href="../lib/images/referanslar/<?=$referans_dizi['resim']?>" target="_blank">Resmi Gör</a>
                                 <?php
								 }
								 ?></td>
                                 ...
                                 <a href="referans_ekle.php?islem=duzenle&id=<?=$referans_dizi['id']?>" title="Düzenle">
