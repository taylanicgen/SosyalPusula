...
if($_POST['kategori_sira'] && $_GET['islem']=="")
{
	...
	$hedef  = "../lib/images/urun_kategori/".$yeni_isim;
	...
	$kategori_ekle_sorgu=mysql_query("insert into urun_kategori (sira, 
														   kategori_adi, 
														   kategori_resim,
														   durum) 
...
if($_POST['kategori_sira'] && $_GET['islem']=="duzenle")
{
	...
	if($dosya!="")
	{
		$resim_bul=mysql_fetch_array(mysql_query("select * from urun_kategori where id='$duzenlenecek_id'"));
		$resim_sil=unlink("../lib/images/urun_kategori/".$resim_bul['kategori_resim']);
	
		$yonetici_duzenle_sorgu=mysql_query("update urun_kategori set durum='$durum', sira='$kategori_sira', kategori_adi='$kategori_adi', kategori_resim='$yeni_isim' where id='$duzenlenecek_id'");
		
		$gitti=move_uploaded_file($kaynak,$hedef);		
	}
	else
	{	
	$yonetici_duzenle_sorgu=mysql_query("update urun_kategori set durum='$durum', sira='$kategori_sira', kategori_adi='$kategori_adi' where id='$duzenlenecek_id'");
	}
...
if($_GET['islem']=="duzenle")
{
	...
	$kategori_dizi=mysql_fetch_array(mysql_query("select * from urun_kategori where id = '$id'"));
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-sitemap"></i> Ürün Kategori Ekleme / Güncelleme</h4>
