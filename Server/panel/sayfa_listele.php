...
if($_GET['islem']=="sil")
{
	...
	$resim_bul=mysql_fetch_array(mysql_query("select * from sayfalar where id='$id'"));
	$resim_sil=unlink("../lib/images/sayfalar/".$resim_bul['resim']);
	
	$sayfa_sil_sorgu = mysql_query("delete from sayfalar where id='$id'");
               ...
               <div class="span12">
                  ...
                  <div class="widget box light-grey">
                     <div class="widget-title">
                        <h4><i class="icon-edit"></i> Sayfa Listesi</h4>
                     ...
                     <div class="widget-body">
                        <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              ...
                              <a href="sayfa_ekle.php" style="color:#FFF;">Sayfa Ekle</a> <i class="icon-plus"></i>
                              </div>
                           </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           <thead>
                              <tr>
                                 ...
                                 <th> Sayfa Adı <i class="icon-angle-down" style="float:right;"></th>
                                 <th class="hidden-480">Sayfa Resmi <i class="icon-angle-down" style="float:right;"></th>
                           ...
                           <?php
						    $sayfa_cek=mysql_query("select * from sayfalar order by sira asc");
							while($sayfa_dizi=mysql_fetch_array($sayfa_cek))
							{
						   ?>
                           
                              <tr class="odd gradeX">
                                 <td><?=$sayfa_dizi['sira']?></td>
                                 <td><?=$sayfa_dizi['adi']?></td>
                                 <td>
                                 <?php
								 if($sayfa_dizi['resim']=="no-image")
								 {
								 echo "Resim yok";
								 }
								 else
								 {
								 ?>
                                 <a href="../lib/images/sayfalar/<?=$sayfa_dizi['resim']?>" target="_blank">Resmi Gör</a>
                                 <?php
								 }
								 ?>
                                 ...
                                 <td >
                                 <a href="?islem=sil&id=<?=$sayfa_dizi['id']?>" title="Sil" onclick="return confirm('Silmek istediğinize emin misiniz ?')">
                                 <i class="icon-remove sercan_sil_icon"></i>
                                 </a>
                                 
                                 <a href="sayfa_ekle.php?islem=duzenle&id=<?=$sayfa_dizi['id']?>" title="Düzenle">
