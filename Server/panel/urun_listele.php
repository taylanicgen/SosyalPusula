...
if($_GET['islem']=="sil")
{
	...
	$resim_bul=mysql_fetch_array(mysql_query("select * from urunler where id='$id'"));
	$resim_sil=unlink("../lib/images/urunler/".$resim_bul['resim']);
	
	$fotograf_sil_sorgu = mysql_query("delete from urunler where id='$id'");
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
                           <thead>
                              <tr>
                                 ...
                                 <th class="hidden-480">Ürün Resmi <i class="icon-angle-down" style="float:right;"></th>
                           ...
                           <?php
						    $kategori_cek=mysql_query("select * from urunler order by sira asc");
						   ...
						   ?>
                              ...
                              <tr class="odd gradeX">
								 ...
								 $kategori_cekk=mysql_query("select * from urun_kategori where id='$kategori_id'");
								 ...
								 {
								 ?>
                                 <a href="../lib/images/urunler/<?=$kategori_dizi['resim']?>" target="_blank">Resmi Gör</a>
                                 <?php
								 }
								 ?></td>
                                 ...
                                 <a href="urun_ekle.php?islem=duzenle&id=<?=$kategori_dizi['id']?>" title="Düzenle">
