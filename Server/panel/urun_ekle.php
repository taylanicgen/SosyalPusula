...
if($_POST['fotograf_sira'] && $_GET['islem']=="")
{
	$fotograf_sira = $_POST['fotograf_sira'];
	$fotograf_adi = $_POST['fotograf_adi'];
	...
	$random2 = rand(0,9999);
	$yeni_isim2 = $random2."_".$dosya2;
	$hedef2  = "../lib/images/urunler/".$yeni_isim2;
	
	$kaynak3 = $_FILES["resim3"]["tmp_name"];  
	$dosya3 = $_FILES["resim3"]["name"];
	$uzanti3 = explode(".", $_FILES[resim3][name]); 
	$random3 = rand(0,9999);
	$yeni_isim3 = $random3."_".$dosya3;
	$hedef3  = "../lib/images/urunler/".$yeni_isim3;
	
	$kaynak4 = $_FILES["resim4"]["tmp_name"];  
	$dosya4 = $_FILES["resim4"]["name"];
	$uzanti4 = explode(".", $_FILES[resim4][name]); 
	$random4 = rand(0,9999);
	$yeni_isim4 = $random4."_".$dosya4;
	$hedef4  = "../lib/images/urunler/".$yeni_isim4;
	...
	$kategori_ekle_sorgu=mysql_query("insert into urunler (sira, 
														   			adi, 
														   			resim,
																	resim2,
																	resim3,
...
if($_POST['fotograf_sira'] && $_GET['islem']=="duzenle")
{
	$fotograf_sira = $_POST['fotograf_sira'];
	$fotograf_adi = $_POST['fotograf_adi'];
	$kategori = $_POST['kategori'];
	...
	if($dosya!="")
	{
		$resim_bul=mysql_fetch_array(mysql_query("select * from urunler where id='$duzenlenecek_id'"));
		$resim_sil=unlink("../lib/images/urunler/".$resim_bul['resim']);
	
		$fotograf_duzenle_sorgu=mysql_query("update urunler set durum='$durum', fiyat='$fiyat', aciklama='$aciklama', sira='$fotograf_sira', adi='$fotograf_adi', resim='$yeni_isim', kategori='$kategori' where id='$duzenlenecek_id'");
		
		$gitti=move_uploaded_file($kaynak,$hedef);		
	}
	else
	{	
	$fotograf_duzenle_sorgu=mysql_query("update urunler set durum='$durum', fiyat='$fiyat', aciklama='$aciklama', sira='$fotograf_sira', adi='$fotograf_adi', kategori='$kategori' where id='$duzenlenecek_id'");
	}
...
if($_GET['islem']=="duzenle")
{
	...
	$fotograf_dizi=mysql_fetch_array(mysql_query("select * from urunler where id='$foto_id'"));
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-bookmark-empty"></i> Ürün Ekleme / Güncelleme</h4>
                    ...
                    <?=$bilgi?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text" name="fotograf_sira" data-required="1" class="span6 " value="<?=$fotograf_dizi['sira']?>"/>
                              </div>
                           </div>
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                 <select class="input-large" tabindex="1" name="kategori">
                                 
                                 <option value="0">Seçiniz</option>
                                 
                                 <?php
									$kategori_cek=mysql_query("select * from urun_kategori order by sira asc");
									while($kategori_dizi=mysql_fetch_array($kategori_cek))
									{
								 ?>
                                 
                                    <option value="<?=$kategori_dizi['id']?>" <?php if($kategori_dizi['id']==$fotograf_dizi['kategori']) { ?> selected="selected" <?php } ?>><?=$kategori_dizi['kategori_adi']?></option>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input name="fotograf_adi" type="text" class="span6 " value="<?=$fotograf_dizi['adi']?>"/>
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input name="fiyat" type="text" class="span6 " value="<?=$fotograf_dizi['fiyat']?>"/>
                              </div>
                           </div>
                           
                           
                           <div class="control-group">
                              <label class="control-label">Resmi</label>
                              <div class="controls">
                           ...
                           <div class="control-group">
                              <label class="control-label">Resmi 2</label>
                              <div class="controls">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                       <div class="input-append">
                                          <div class="uneditable-input">
                           ...
                           <div class="control-group">
                              <label class="control-label">Resmi 3</label>
                              <div class="controls">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                       <div class="input-append">
                                          <div class="uneditable-input">
                           ...
                           <div class="control-group">
                              <label class="control-label">Resmi 4</label>
                              <div class="controls">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                       <div class="input-append">
                                          <div class="uneditable-input">
                           ...
                           <div class="control-group">
                                 ...
                                 <div class="controls">
                                    <div class="basic-toggle-button">
									  ...
									  {
									 ?>
                                     <input type="checkbox" class="toggle" name="durum" <?php if($fotograf_dizi['durum']=='1') {?>checked="checked" <?php } ?> value="1" />
                                     <?php
									  }
									  else
									  {
                              ...
                              <div class="control-group">
                                 ...
                                 <div class="controls">
                                    <textarea class="span12 ckeditor m-wrap" name="aciklama" rows="6"><?=$fotograf_dizi['aciklama']?></textarea>
                                 </div>
                              </div>
