...
if($_POST['duyuru_sira'] && $_GET['islem']=="")
{
	$duyuru_sira = $_POST['duyuru_sira'];
	$duyuru_adi = $_POST['duyuru_adi'];
	$durum = $_POST['durum'];
	...
	$hedef  = "../lib/images/duyurular/".$yeni_isim;
	...
	$duyuru_ekle_sorgu=mysql_query("insert into duyurular (sira, 
														   adi, 
														   resim,
														   durum,
														   aciklama) 
...
if($_POST['duyuru_sira'] && $_GET['islem']=="duzenle")
{
	$duyuru_sira = $_POST['duyuru_sira'];
	$duyuru_adi = $_POST['duyuru_adi'];
	...
	if($dosya!="")
	{
		$resim_bul=mysql_fetch_array(mysql_query("select * from duyurular where id='$duzenlenecek_id'"));
		$resim_sil=unlink("../lib/images/duyurular/".$resim_bul['resim']);
	
		$duyuru_duzenle_sorgu=mysql_query("update duyurular set durum='$durum', sira='$duyuru_sira', adi='$duyuru_adi', resim='$yeni_isim', aciklama='$aciklama' where id='$duzenlenecek_id'");
		
		$gitti=move_uploaded_file($kaynak,$hedef);		
	}
	else
	{	
	$duyuru_duzenle_sorgu=mysql_query("update duyurular set durum='$durum', aciklama='$aciklama', sira='$duyuru_sira', adi='$duyuru_adi' where id='$duzenlenecek_id'");
	}
...
if($_GET['islem']=="duzenle")
{
	...
	$duyuru_dizi=mysql_fetch_array(mysql_query("select * from duyurular where id = '$id'"));
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-bullhorn"></i> Duyuru Ekleme / Güncelleme</h4>
                    ...
                    <?=$bilgi?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="control-group">
                              <label class="control-label">Duyuru Sırası</label>
                              <div class="controls">
                                 <input type="text" name="duyuru_sira" data-required="1" class="span6 " value="<?=$duyuru_dizi['sira']?>"/>
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input name="duyuru_adi" type="text" class="span6 " value="<?=$duyuru_dizi['adi']?>"/>
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                                 ...
                                 <div class="controls">
                                    <div class="basic-toggle-button">
									  ...
									  {
									 ?>
                                     <input type="checkbox" class="toggle" name="durum" <?php if($duyuru_dizi['durum']=='1') {?>checked="checked" <?php } ?> value="1" />
                                     <?php
									  }
									  else
									  {
                           ...
                           <div class="control-group">
                                 ...
                                 <div class="controls">
                                    <textarea class="span12 ckeditor m-wrap" name="aciklama" rows="6"><?=$duyuru_dizi['aciklama']?></textarea>
                                 </div>
                              </div>
