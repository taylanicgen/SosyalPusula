...
if($_POST['sira'] && $_GET['islem']=="")
{
	...
	$hedef  = "../lib/images/referanslar/".$yeni_isim;
	...
	$kategori_ekle_sorgu=mysql_query("insert into referanslar (sira, 
														   			adi, 
														   			resim,
																	durum) 
														   			values ('$sira',
...
if($_POST['sira'] && $_GET['islem']=="duzenle")
{
	...
	if($dosya!="")
	{
		$resim_bul=mysql_fetch_array(mysql_query("select * from referanslar where id='$duzenlenecek_id'"));
		$resim_sil=unlink("../lib/images/referanslar/".$resim_bul['resim']);
	
		$fotograf_duzenle_sorgu=mysql_query("update referanslar set durum='$durum', sira='$sira', adi='$adi', resim='$yeni_isim' where id='$duzenlenecek_id'");
		
		$gitti=move_uploaded_file($kaynak,$hedef);		
	}
	else
	{	
	$referans_duzenle_sorgu=mysql_query("update referanslar set durum='$durum', sira='$sira', adi='$adi' where id='$duzenlenecek_id'");
	}
...
if($_GET['islem']=="duzenle")
{
	...
	$referans_dizi=mysql_fetch_array(mysql_query("select * from referanslar where id='$foto_id'"));
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-tags"></i> Referans Ekleme / Güncelleme</h4>
                    ...
                    <?=$bilgi?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="control-group">
                              <label class="control-label">Referans Sırası</label>
                              <div class="controls">
                                 <input type="text" name="sira" data-required="1" class="span6 " value="<?=$referans_dizi['sira']?>"/>
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input name="adi" type="text" class="span6 " value="<?=$referans_dizi['adi']?>"/>
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                                 ...
                                 <div class="controls">
                                    <div class="basic-toggle-button">
									  ...
									  {
									 ?>
                                     <input type="checkbox" class="toggle" name="durum" <?php if($referans_dizi['durum']=='1') {?>checked="checked" <?php } ?> value="1" />
                                     <?php
									  }
									  else
									  {
