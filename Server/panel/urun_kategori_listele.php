...
if($_GET['islem']=="sil")
{
	...
	$resim_bul=mysql_fetch_array(mysql_query("select * from urun_kategori where id='$id'"));
	$resim_sil=unlink("../lib/images/urun_kategori/".$resim_bul['kategori_resim']);
	
	$kategori_sil_sorgu = mysql_query("delete from urun_kategori where id='$id'");
               ...
               <div class="span12">
                  ...
                  <div class="widget box light-grey">
                     <div class="widget-title">
                        <h4><i class="icon-sitemap"></i> Ürün Kategori Listesi</h4>
                     ...
                     <div class="widget-body">
                        <div class="clearfix margin-bottom-10">
                           <div class="btn-group">
                              ...
                              <a href="urun_kategori_ekle.php" style="color:#FFF;">Kategori Ekle</a> <i class="icon-plus"></i>
                              </div>
                           </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1" style="font-size:12px;">
						   ...
						   ?>
                              ...
                              <tr class="odd gradeX">
								 ...
								 {
								 ?>
                                 <a href="../lib/images/urun_kategori/<?=$kategori_dizi['kategori_resim']?>" target="_blank">Resmi Gör</a>
                                 <?php
								 }
								 ?>
                                 ...
                                 <a href="urun_kategori_ekle.php?islem=duzenle&id=<?=$kategori_dizi['id']?>" title="Düzenle">
