...
if($_POST['kategori_sira'] && $_GET['islem']=="")
{
	...
	$kaynak = $_FILES["kategori_resim"]["tmp_name"];  
	$dosya = $_FILES["kategori_resim"]["name"];
	$uzanti = explode(".", $_FILES[kategori_resim][name]); 
	$random = rand(0,9999);
	$yeni_isim = $random."_".$dosya;
	$hedef  = "../lib/images/fotograf_kategori/".$yeni_isim;
	...
	$kategori_ekle_sorgu=mysql_query("insert into fotograf_galeri_kategori (sira, 
														   kategori_adi, 
														   kategori_resim,
														   durum) 
														   values ('$kategori_sira',
																   '$kategori_adi',
																   '$yeni_isim',
																   '$durum')");
...
if($_POST['kategori_sira'] && $_GET['islem']=="duzenle")
{
	$kategori_sira = $_POST['kategori_sira'];
	$kategori_adi = $_POST['kategori_adi'];
	...
	if($dosya!="")
	{
		$resim_bul=mysql_fetch_array(mysql_query("select * from fotograf_galeri_kategori where id='$duzenlenecek_id'"));
		$resim_sil=unlink("../lib/images/fotograf_kategori/".$resim_bul['kategori_resim']);
	
		$yonetici_duzenle_sorgu=mysql_query("update fotograf_galeri_kategori set durum='$durum', sira='$kategori_sira', kategori_adi='$kategori_adi', kategori_resim='$yeni_isim' where id='$duzenlenecek_id'");
		
		$gitti=move_uploaded_file($kaynak,$hedef);		
	}
	else
	{	
	$yonetici_duzenle_sorgu=mysql_query("update fotograf_galeri_kategori set durum='$durum', sira='$kategori_sira', kategori_adi='$kategori_adi' where id='$duzenlenecek_id'");
	}
...
if($_GET['islem']=="duzenle")
{
	...
	$kategori_dizi=mysql_fetch_array(mysql_query("select * from fotograf_galeri_kategori where id = '$id'"));
				...
				<div id="page" class="dashboard">
                	...
                	<div class="widget box light-grey">
                     ...
                     <div class="widget-title">
                        ...
                        <h4><i class="icon-camera"></i> Fotoğraf Kategori Ekleme / Güncelleme</h4>
                    ...
                    <?=$bilgi?>
                        ...
                        <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text" name="kategori_sira" data-required="1" class="span6 " value="<?=$kategori_dizi['sira']?>"/>
                              </div>
                           </div>
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input name="kategori_adi" type="text" class="span6 " value="<?=$kategori_dizi['kategori_adi']?>"/>
                              </div>
                           </div>
                              ...
                              <div class="controls">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                       <div class="input-append">
                                          ...
                                          <input type="file" name="kategori_resim" class="default" />
                                          </span>
                           ...
                           <div class="control-group">
                                 ...
                                 <div class="controls">
                                    <div class="basic-toggle-button">
									  ...
									  {
									 ?>
                                     <input type="checkbox" class="toggle" name="durum" <?php if($kategori_dizi['durum']=='1') {?>checked="checked" <?php } ?> value="1" />
                                     <?php
									  }
									  else
									  {
