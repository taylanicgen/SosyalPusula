...
if($_POST['sayfa_sira'] && $_GET['islem']=="")
{
	...
	$hedef  = "../lib/images/sayfalar/".$yeni_isim;
...
if($_POST['sayfa_sira'] && $_GET['islem']=="duzenle")
{
	...
	if($dosya!="")
	{
		...
		$sayfa_duzenle_sorgu=mysql_query("update sayfalar set durum='$durum', sira='$sayfa_sira', adi='$sayfa_adi', resim='$yeni_isim', aciklama='$aciklama' where id='$duzenlenecek_id'");
