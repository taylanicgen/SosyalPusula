...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_LOGIN_TABLE = "CREATE TABLE " + TABLE_USER + "("
                ...
                + KEY_CREATED_AT + " TEXT,"
                + KEY_USERNAME + " TEXT ," + KEY_PHONE + " TEXT,"
                + KEY_SEX + " TEXT " + ")";
     ...
     * */
    public void addUser(String name, String email, String uid, String created_at,String username,String phone, String sex) {
